...
export const Text = ({ size = "sm", children, ...rest }: TextProps) => {
  return (
    ...
    // token is a trem used by antd to refer to he design tokens like font size, font weight, color, etc
    // https://ant.design/docs/react/customize-theme#cutomize-design-token
    <ConfigProvider
      theme={{
        token: {
          ...sizes[size],
