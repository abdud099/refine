...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
  /**
   * useForm is refine is used to manage forms. It provides us with a lot of useful props and methods thats we can use to manage froms.
  ...
  const {
     ...
     * https://refine.dev/docs/data/packages/nextjs-Query/#getfields
     */
    GetFields<UpdateUserMutation>,
    // a type that represents an HTTP error. Used to specify the type of error mutation can throw
    HttpError,
    // A thired type parameter used to specify the type of variables for the UpdateUserMutation. Meaning that the variables for the UpdateUserMutation should be of type UpdateUserMutationVariables
  ...
  >({
     ...
     * optimistic -> redirection and UI updates are executed immediately as id the mutation is successful.
     * pessimistic -> redirection and UL updates are executed after the mutation is successful.
     * https://refine.dev/docs/advanced-tutorials/mutation-mode/
     */
    ...
    resource: "users",
    /**
     * specify the action that should be performed on the resource, Behind the scenes, Refine calls useOne hook to get the data of the user fot edit action.
